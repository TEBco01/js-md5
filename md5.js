...
function md5_transform(ctx, buf) {
  ...
  X_6  = buf[24] | (buf[21] << 8) | (buf[25] << 16) | (buf[26] << 24);
  X_7  = buf[27] | (buf[28] << 8) | (buf[29] << 16) | (buf[30] << 24);
  X_8  = buf[31] | (buf[32] << 8) | (buf[33] << 16) | (buf[34] << 24);
  X_9  = buf[35] | (buf[36] << 8) | (buf[37] << 16) | (buf[38] << 24);
  X_10 = buf[39] | (buf[40] << 8) | (buf[41] << 16) | (buf[42] << 24);
  X_11 = buf[43] | (buf[44] << 8) | (buf[45] << 16) | (buf[46] << 24);
  X_12 = buf[47] | (buf[48] << 8) | (buf[49] << 16) | (buf[50] << 24);
  X_13 = buf[51] | (buf[52] << 8) | (buf[53] << 16) | (buf[54] << 24);
  X_14 = buf[55] | (buf[56] << 8) | (buf[57] << 16) | (buf[58] << 24);
  X_15 = buf[59] | (buf[60] << 8) | (buf[61] << 16) | (buf[62] << 24);
